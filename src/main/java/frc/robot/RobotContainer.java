...
import frc.robot.commands.swervedrive.drivebase.ElavatorCommand;
import frc.robot.commands.swervedrive.drivebase.SetElavatorPositionCommand;
...
public class RobotContainer
{
  ...
  private final POVButton dpadUpButton    = new POVButton(driverPs5Controller.getHID(), 0);
  private final POVButton dpadRightButton = new POVButton(driverPs5Controller.getHID(), 90);
  private final POVButton dpadDownButton  = new POVButton(driverPs5Controller.getHID(), 180);
  ...
  AbsoluteDriveAdv closedAbsoluteDriveAdv = new AbsoluteDriveAdv(
      ...
      () -> -MathUtil.applyDeadband(driverPs5Controller.getRightX(), OperatorConstants.RIGHT_X_DEADBAND),
  ...
  .withControllerRotationAxis(driverPs5Controller::getRightX)
