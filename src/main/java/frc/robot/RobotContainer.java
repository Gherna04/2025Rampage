...
public class RobotContainer {
  ...
  final CommandXboxController xbox = new CommandXboxController(2);
  final CommandPS5Controller driverPs5 = new CommandPS5Controller(0);
  //final CommandJoystick mechJoystick = new CommandJoystick(1);
  ...
  public RobotContainer() {
   ...
   configureBindings();
    ...
    //AMP
  //   driverPs5.button(6)
  //       .whileTrue(amp.forwardAmp())
  //       .whileFalse(amp.stopAmp());
    
  //   driverPs5.button(5)
  //       .whileTrue(amp.reverseAmp())
  //       .whileFalse(amp.stopAmp());
